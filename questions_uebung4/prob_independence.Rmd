...
Diese Wahrscheinlichkeiten berechnen sich in R folgender massen:
...
Aus $P(Z = ja) \cdot P(Stadt = A)$ ergibt sich $`r round(multi_test,4)`$. Diese Wahrscheinlichkeit ist ungleich der berechneten Wahrscheinlichkeit von $P(Z = ja \cap Stadt = A) = `r round(p_union_Azufrieden,4)`$. Daraus können wir schliessen, dass die Wahrschinlihckeiten nicht voneinander unabhängig sind.

Die Lösung für die bedingten Wahrscheinlichkeiten folgt.
