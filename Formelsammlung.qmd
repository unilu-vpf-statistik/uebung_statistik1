...
$$
\hat{\mu}  \pm t_{1-\alpha/2}(df = N-1) * \hat{\sigma} = \bar{x} \pm t_{1-\alpha/2}(df = N-1) \cdot \frac{s_X}{\sqrt{N-1}}
$$

für *nach unten* oder *nach oben* geschlossene Grenzen, berechnet sich die Grenze:

$$
\hat{\mu}  \pm t_{1-\alpha}(df = N-1) * \hat{\sigma} = \bar{x} \pm t_{1-\alpha}(df = N-1) \cdot \frac{s_X}{\sqrt{N-1}}
$$
